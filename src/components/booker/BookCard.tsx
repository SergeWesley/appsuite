    ...
    >
      ...
      {hasActiveTimer && (
        ...
        >
          ...
          <div className="ml-auto flex">
            ...
            <div
              className="w-1 h-1 bg-white rounded-full animate-pulse ml-1"
      ...
      <div className="flex items-center gap-2 ml-4">
        ...
        <div className="flex gap-1 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
          ...
          >
            <BookOpen
              size={16}
              className={hasActiveTimer ? "animate-pulse" : ""}
            />
          </button>
          <button
            onClick={(e) => {
      ...
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          {book.genre && (
            <p className="text-xs text-gray-500 mt-2">{book.genre}</p>
          )}
        </div>
      ...
      {book.notes && (
        <div className="mt-4 p-3 bg-gray-50 rounded-lg">
          <p className="text-sm text-gray-700 line-clamp-2">{book.notes}</p>
        </div>
      )}
    </motion.div>
  );
