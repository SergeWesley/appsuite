...
import { Type, List, Hash, Calendar, CheckSquare, Palette, Star, Link, Euro, Table, Plus, X } from "lucide-react";
            ...
            <thead className="bg-gray-50 uppercase text-xs font-semibold text-gray-500 border-b border-gray-200">
              <tr>
                {field.columns.map((col) => (
                  <th key={col.id} className="px-3 py-2 whitespace-nowrap">{col.name}</th>
                ))}
